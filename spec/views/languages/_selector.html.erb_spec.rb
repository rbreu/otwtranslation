...
describe "otwtranslation/languages/_selector.html.erb" do
  it "should display the visible languages" do
    Factory.create(:language, :name => 'English', :translation_visible => true)
    Factory.create(:language, :name => 'Deutsch', :translation_visible => true)
    render
  ...
  it "should not display the invisible languages" do
    Factory.create(:language, :name => 'English', :translation_visible => true)
    Factory.create(:language, :name => 'Deutsch', :translation_visible => false)
    render
    rendered.should contain 'English'
